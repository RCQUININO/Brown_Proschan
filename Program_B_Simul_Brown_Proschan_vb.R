...
n <- 20 # A value exceeding the average number of failures, adjusted for 
#computational efficiency.Convergence must be verified.Although using the 
#truncation value is sufficient, it leads to slower computation.
...
cat("Mean failures=",mean(falhas[,1]),"\n")
